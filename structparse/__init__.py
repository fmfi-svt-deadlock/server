"""Simplifies parsing "C structs" -- structured types serialized as byte arrays."""
...
def mystruct(name, *fields):
    ...
    class Cls(MyStructMixin, namedtuple(name, fieldnames)): pass
    Cls.__name__ = name
